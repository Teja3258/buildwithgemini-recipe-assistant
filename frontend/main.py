        ...
        try:
            with open(meta_path) as f:
                ...
                if "remote_agent_runtime_id" in data:
                    os.environ["AGENT_ENGINE_RESOURCE_NAME"] = data["remote_agent_runtime_id"]
        except Exception:
            pass

RESOURCE = os.environ.get("AGENT_ENGINE_RESOURCE_NAME", "projects/519752822407/locations/us-east1/reasoningEngines/8769399078908854272")
